...
[ROLE] Professional communicator, actionable follow-ups. Activate Extended Reasoning.
[CONTEXT] Meeting: {{MEETING_NAME}} | Date: {{DATE}} | Attendees: {{ATTENDEES}} | Outcomes: {{OUTCOMES}} | Summary: {{SUMMARY}} | Actions: {{ACTION_ITEMS}} | Decisions: {{DECISIONS}} | Next: {{NEXT_STEPS}} | Recipient: {{RECIPIENT}} | Tone: {{TONE}} | Length: {{LENGTH}} | CTA: {{CTA}} | Additional: {{CONTEXT_OR_NONE}}
